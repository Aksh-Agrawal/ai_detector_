      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            A comprehensive AI detection platform with multilingual voice assistant
            analyzing text, images, videos, and documents using cutting-edge machine
            learning and natural language processing across 10+ Indian languages.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            sophisticated, our mission is to provide transparent, accurate, and accessible
          ...
          <p className="text-gray-700 leading-relaxed">
            With 88.5% detection accuracy across 4 content types and support for 10+ Indian languages
            through our voice assistant, we're making AI detection accessible to diverse communities.
            Our platform combines cutting-edge technology (Sarvam AI, Google Gemini, PyMuPDF) with
            user-friendly design to serve educational institutions, content creators, journalists,
            and anyone concerned about content authenticity.
          </p>
        </motion.div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Choose from 4 detection modes: Text (paste or type), Image (drag-drop), 
                  Video (upload MP4/AVI/MOV), or Document (PDF/DOCX/TXT up to 10MB).
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Our models analyze patterns (perplexity, burstiness, artifacts) using NLP,
                  computer vision, and temporal analysis. Documents get page-by-page breakdown.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  View AI vs Human probability scores with animated visualizations. Use the floating
                  chat widget to ask our voice assistant "Why is this AI?" in English or Hindi!
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <p className="mb-2">
            <strong className="text-gray-700">AI Content Detector v2.0</strong> - 
            Built with passion for transparency and authenticity in digital content.
          </p>
          <p className="mb-4 text-xs">
            Achieved 88.5% accuracy • 4 content types • 10+ languages • Real-time voice assistant
          </p>
