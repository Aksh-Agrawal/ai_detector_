        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              tools for content verification. We believe in empowering users
              with the ability to distinguish between human-created and
              AI-generated content, fostering trust and authenticity in digital
              media.
            </p>
          </motion.div>
